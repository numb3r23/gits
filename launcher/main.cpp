...
static bool SetupWindow() {
  ...
  g_WC = {
      ...
      nullptr, nullptr, gits::gui::Settings::WINDOW_TITLE_W, hIcon};
...
static bool SetupWindow() {
  ...
  g_GLFWWindow = glfwCreateWindow((int)(g_LauncherConfig.WindowSize.x * main_scale), (int)(g_LauncherConfig.WindowSize.y * main_scale), gits::gui::Settings::WINDOW_TITLE, nullptr, nullptr);
...
#else
  g_GUI = new gits::gui::GUIController();
#endif
  g_GUI->SetupGui();
}
